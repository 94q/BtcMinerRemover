@echo off
title TJprojMain remover | Made by ice bear | https://github.com/jnajwhdanbiwduanwdioayuhbou2qgybroq
...
:end
cls
echo Done! explorer.exe/svchost.exe (TJprojMain) is now removed
PAUSE
