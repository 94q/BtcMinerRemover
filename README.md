...
This simple batch script will get rid of the annoying TJprojMain malware, also known as fake explorer.exe/svchost.exe(btc miner), which infects all your exe files to spread and disguises itself as common system files.
